...
- **No Tracking by Default**: Analytics and crash reporting tools are disabled by default.  
...
- To improve app stability and performance (if crash reporting enabled).  
- To improve app features and user experience (if analytics enabled).  

## 3. Cookies and Tracking
- [REDACTED] does not use cookies or tracking technologies by default.  
- Optional services may collect anonymous analytics if you enable them.
